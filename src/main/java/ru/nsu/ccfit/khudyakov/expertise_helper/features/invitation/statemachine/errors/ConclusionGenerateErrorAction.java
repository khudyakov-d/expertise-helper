...
@Component
public class ConclusionGenerateErrorAction implements Action<InvitationState, InvitationEvent> {

    @Override
    public void execute(StateContext<InvitationState, InvitationEvent> context) {
        context.getStateMachine().sendEvent(InvitationEvent.CONCLUSION_GENERATE_FAILURE);
    }
